...
const doc = S('document', { title: 'Service invoice', custodian: 'Seed Holdings', date: '2025-10-01', bates: 'DEF-000001', privilege: 'none', responsive: true, issues: ['damages'], author: 'A. Clerk', recipients: 'Ops', dateCreated: '2025-10-01', privDesc: '' });
S('document', { title: 'Counsel memo', custodian: 'Seed Holdings', date: '2025-10-05', bates: 'DEF-000002', privilege: 'solicitor-client', responsive: true, author: 'Counsel', recipients: 'Client', privDesc: 'Legal advice re claim' });
